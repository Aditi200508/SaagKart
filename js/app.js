...
checkoutForm.addEventListener('submit', async (e) => {
  ...
  try {
    const res = await fetch('http://localhost/SaagKart/backend/orders.php', {
      method: 'POST',
...
contactForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const res = await fetch('http://localhost/SaagKart/backend/contact.php', { method: 'POST', body: formData });
    ...
    console.error('Error:', err); alert('Could not send message.');
  }
});
